def get_races():
    return {'White', 'Black', 'Asian-Pac-Islander', 'Other',
       'Amer-Indian-Eskimo'}

def get_workclasses():
    return {'Private', 'State-gov', 'Self-emp-not-inc', 'Federal-gov',
       'Local-gov', 'Self-emp-inc', 'Never-worked', 'Without-pay'}

def get_educations():
    return {'Doctorate', '12th', 'Bachelors', '7th-8th', 'Some-college',
       'HS-grad', '9th', '10th', '11th', 'Masters', 'Preschool',
       '5th-6th', 'Prof-school', 'Assoc-voc', '1st-4th', 'Assoc-acdm'}

def get_maritial_status():
    return {'Divorced', 'Never-married', 'Married-civ-spouse', 'Widowed',
       'Separated', 'Married-spouse-absent', 'Married-AF-spouse'}

def get_occupations():
    return {'Exec-managerial', 'Other-service', 'Transport-moving',
       'Adm-clerical', 'Machine-op-inspct', 'Sales', 'Handlers-cleaners',
       'Farming-fishing', 'Protective-serv', 'Prof-specialty',
       'Craft-repair', 'Tech-support', 'Priv-house-serv',
       'Armed-Forces'}

def get_relationships():
    return {'Not-in-family', 'Own-child', 'Husband', 'Wife', 'Unmarried',
       'Other-relative'}

def get_genders():
    return {'Male', 'Female'}

def get_native_countries():
    return {'United-States', 'Japan', 'South', 'Portugal', 'Italy', 'Mexico',
